      ...
      0083F9 81               [ 4]   84 	ret
                                     ...
                                     88 ;	-----------------------------------------
      0083FA                         89 _TIM4_TimeBaseInit:
                                     90 ;	lib/src/stm8s_tim4.c: 70: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      0083FA C7 53 47         [ 1]   91 	ld	0x5347, a
                                     92 ;	lib/src/stm8s_tim4.c: 72: TIM4->ARR = (uint8_t)(TIM4_Period);
      0083FD AE 53 48         [ 2]   93 	ldw	x, #0x5348
      008400 7B 03            [ 1]   94 	ld	a, (0x03, sp)
      008402 F7               [ 1]   95 	ld	(x), a
                                     96 ;	lib/src/stm8s_tim4.c: 73: }
      008403 85               [ 2]   97 	popw	x
      008404 84               [ 1]   98 	pop	a
      008405 FC               [ 2]   99 	jp	(x)
                                    100 ;	lib/src/stm8s_tim4.c: 81: void TIM4_Cmd(FunctionalState NewState)
                                    101 ;	-----------------------------------------
                                    102 ;	 function TIM4_Cmd
                                    103 ;	-----------------------------------------
      008406                        104 _TIM4_Cmd:
      008406 88               [ 1]  105 	push	a
      008407 6B 01            [ 1]  106 	ld	(0x01, sp), a
                                    107 ;	lib/src/stm8s_tim4.c: 89: TIM4->CR1 |= TIM4_CR1_CEN;
      008409 C6 53 40         [ 1]  108 	ld	a, 0x5340
                                    109 ;	lib/src/stm8s_tim4.c: 87: if (NewState != DISABLE)
      00840C 0D 01            [ 1]  110 	tnz	(0x01, sp)
      00840E 27 07            [ 1]  111 	jreq	00102$
                                    112 ;	lib/src/stm8s_tim4.c: 89: TIM4->CR1 |= TIM4_CR1_CEN;
      008410 AA 01            [ 1]  113 	or	a, #0x01
      008412 C7 53 40         [ 1]  114 	ld	0x5340, a
      008415 20 05            [ 2]  115 	jra	00104$
      008417                        116 00102$:
                                    117 ;	lib/src/stm8s_tim4.c: 93: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_CEN);
      008417 A4 FE            [ 1]  118 	and	a, #0xfe
      008419 C7 53 40         [ 1]  119 	ld	0x5340, a
      00841C                        120 00104$:
                                    121 ;	lib/src/stm8s_tim4.c: 95: }
      00841C 84               [ 1]  122 	pop	a
      00841D 81               [ 4]  123 	ret
                                    ...
                                    127 ;	-----------------------------------------
      00841E                        128 _TIM4_ITConfig:
      00841E 88               [ 1]  129 	push	a
      00841F 97               [ 1]  130 	ld	xl, a
                                    131 ;	lib/src/stm8s_tim4.c: 116: TIM4->IER |= (uint8_t)TIM4_IT;
      008420 C6 53 43         [ 1]  132 	ld	a, 0x5343
      008423 6B 01            [ 1]  133 	ld	(0x01, sp), a
                                    134 ;	lib/src/stm8s_tim4.c: 113: if (NewState != DISABLE)
      008425 0D 04            [ 1]  135 	tnz	(0x04, sp)
      008427 27 08            [ 1]  136 	jreq	00102$
                                    137 ;	lib/src/stm8s_tim4.c: 116: TIM4->IER |= (uint8_t)TIM4_IT;
      008429 9F               [ 1]  138 	ld	a, xl
      00842A 1A 01            [ 1]  139 	or	a, (0x01, sp)
      00842C C7 53 43         [ 1]  140 	ld	0x5343, a
      00842F 20 07            [ 2]  141 	jra	00104$
      008431                        142 00102$:
                                    143 ;	lib/src/stm8s_tim4.c: 121: TIM4->IER &= (uint8_t)(~TIM4_IT);
      008431 9F               [ 1]  144 	ld	a, xl
      008432 43               [ 1]  145 	cpl	a
      008433 14 01            [ 1]  146 	and	a, (0x01, sp)
      008435 C7 53 43         [ 1]  147 	ld	0x5343, a
      008438                        148 00104$:
                                    149 ;	lib/src/stm8s_tim4.c: 123: }
      008438 84               [ 1]  150 	pop	a
      008439 85               [ 2]  151 	popw	x
      00843A 84               [ 1]  152 	pop	a
      00843B FC               [ 2]  153 	jp	(x)
                                    154 ;	lib/src/stm8s_tim4.c: 131: void TIM4_UpdateDisableConfig(FunctionalState NewState)
                                    155 ;	-----------------------------------------
                                    156 ;	 function TIM4_UpdateDisableConfig
                                    157 ;	-----------------------------------------
      00843C                        158 _TIM4_UpdateDisableConfig:
      00843C 88               [ 1]  159 	push	a
      00843D 6B 01            [ 1]  160 	ld	(0x01, sp), a
                                    161 ;	lib/src/stm8s_tim4.c: 139: TIM4->CR1 |= TIM4_CR1_UDIS;
      00843F C6 53 40         [ 1]  162 	ld	a, 0x5340
                                    163 ;	lib/src/stm8s_tim4.c: 137: if (NewState != DISABLE)
      008442 0D 01            [ 1]  164 	tnz	(0x01, sp)
      008444 27 07            [ 1]  165 	jreq	00102$
                                    166 ;	lib/src/stm8s_tim4.c: 139: TIM4->CR1 |= TIM4_CR1_UDIS;
      008446 AA 02            [ 1]  167 	or	a, #0x02
      008448 C7 53 40         [ 1]  168 	ld	0x5340, a
      00844B 20 05            [ 2]  169 	jra	00104$
      00844D                        170 00102$:
                                    171 ;	lib/src/stm8s_tim4.c: 143: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_UDIS);
      00844D A4 FD            [ 1]  172 	and	a, #0xfd
      00844F C7 53 40         [ 1]  173 	ld	0x5340, a
      008452                        174 00104$:
                                    175 ;	lib/src/stm8s_tim4.c: 145: }
      008452 84               [ 1]  176 	pop	a
      008453 81               [ 4]  177 	ret
                                    ...
                                    181 ;	-----------------------------------------
      008454                        182 _TIM4_UpdateRequestConfig:
      008454 88               [ 1]  183 	push	a
      008455 6B 01            [ 1]  184 	ld	(0x01, sp), a
                                    185 ;	lib/src/stm8s_tim4.c: 163: TIM4->CR1 |= TIM4_CR1_URS;
      008457 C6 53 40         [ 1]  186 	ld	a, 0x5340
                                    187 ;	lib/src/stm8s_tim4.c: 161: if (TIM4_UpdateSource != TIM4_UPDATESOURCE_GLOBAL)
      00845A 0D 01            [ 1]  188 	tnz	(0x01, sp)
      00845C 27 07            [ 1]  189 	jreq	00102$
                                    190 ;	lib/src/stm8s_tim4.c: 163: TIM4->CR1 |= TIM4_CR1_URS;
      00845E AA 04            [ 1]  191 	or	a, #0x04
      008460 C7 53 40         [ 1]  192 	ld	0x5340, a
      008463 20 05            [ 2]  193 	jra	00104$
      008465                        194 00102$:
                                    195 ;	lib/src/stm8s_tim4.c: 167: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_URS);
      008465 A4 FB            [ 1]  196 	and	a, #0xfb
      008467 C7 53 40         [ 1]  197 	ld	0x5340, a
      00846A                        198 00104$:
                                    199 ;	lib/src/stm8s_tim4.c: 169: }
      00846A 84               [ 1]  200 	pop	a
      00846B 81               [ 4]  201 	ret
                                    ...
                                    205 ;	-----------------------------------------
      00846C                        206 _TIM4_SelectOnePulseMode:
      00846C 88               [ 1]  207 	push	a
      00846D 6B 01            [ 1]  208 	ld	(0x01, sp), a
                                    209 ;	lib/src/stm8s_tim4.c: 187: TIM4->CR1 |= TIM4_CR1_OPM;
      00846F C6 53 40         [ 1]  210 	ld	a, 0x5340
                                    211 ;	lib/src/stm8s_tim4.c: 185: if (TIM4_OPMode != TIM4_OPMODE_REPETITIVE)
      008472 0D 01            [ 1]  212 	tnz	(0x01, sp)
      008474 27 07            [ 1]  213 	jreq	00102$
                                    214 ;	lib/src/stm8s_tim4.c: 187: TIM4->CR1 |= TIM4_CR1_OPM;
      008476 AA 08            [ 1]  215 	or	a, #0x08
      008478 C7 53 40         [ 1]  216 	ld	0x5340, a
      00847B 20 05            [ 2]  217 	jra	00104$
      00847D                        218 00102$:
                                    219 ;	lib/src/stm8s_tim4.c: 191: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_OPM);
      00847D A4 F7            [ 1]  220 	and	a, #0xf7
      00847F C7 53 40         [ 1]  221 	ld	0x5340, a
      008482                        222 00104$:
                                    223 ;	lib/src/stm8s_tim4.c: 193: }
      008482 84               [ 1]  224 	pop	a
      008483 81               [ 4]  225 	ret
                                    ...
                                    229 ;	-----------------------------------------
      008484                        230 _TIM4_PrescalerConfig:
                                    231 ;	lib/src/stm8s_tim4.c: 222: TIM4->PSCR = (uint8_t)Prescaler;
      008484 C7 53 47         [ 1]  232 	ld	0x5347, a
                                    233 ;	lib/src/stm8s_tim4.c: 225: TIM4->EGR = (uint8_t)TIM4_PSCReloadMode;
      008487 7B 03            [ 1]  234 	ld	a, (0x03, sp)
      008489 C7 53 45         [ 1]  235 	ld	0x5345, a
                                    236 ;	lib/src/stm8s_tim4.c: 226: }
      00848C 85               [ 2]  237 	popw	x
      00848D 84               [ 1]  238 	pop	a
      00848E FC               [ 2]  239 	jp	(x)
                                    240 ;	lib/src/stm8s_tim4.c: 234: void TIM4_ARRPreloadConfig(FunctionalState NewState)
                                    241 ;	-----------------------------------------
                                    242 ;	 function TIM4_ARRPreloadConfig
                                    243 ;	-----------------------------------------
      00848F                        244 _TIM4_ARRPreloadConfig:
      00848F 88               [ 1]  245 	push	a
      008490 6B 01            [ 1]  246 	ld	(0x01, sp), a
                                    247 ;	lib/src/stm8s_tim4.c: 242: TIM4->CR1 |= TIM4_CR1_ARPE;
      008492 C6 53 40         [ 1]  248 	ld	a, 0x5340
                                    249 ;	lib/src/stm8s_tim4.c: 240: if (NewState != DISABLE)
      008495 0D 01            [ 1]  250 	tnz	(0x01, sp)
      008497 27 07            [ 1]  251 	jreq	00102$
                                    252 ;	lib/src/stm8s_tim4.c: 242: TIM4->CR1 |= TIM4_CR1_ARPE;
      008499 AA 80            [ 1]  253 	or	a, #0x80
      00849B C7 53 40         [ 1]  254 	ld	0x5340, a
      00849E 20 05            [ 2]  255 	jra	00104$
      0084A0                        256 00102$:
                                    257 ;	lib/src/stm8s_tim4.c: 246: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_ARPE);
      0084A0 A4 7F            [ 1]  258 	and	a, #0x7f
      0084A2 C7 53 40         [ 1]  259 	ld	0x5340, a
      0084A5                        260 00104$:
                                    261 ;	lib/src/stm8s_tim4.c: 248: }
      0084A5 84               [ 1]  262 	pop	a
      0084A6 81               [ 4]  263 	ret
                                    ...
                                    267 ;	-----------------------------------------
      0084A7                        268 _TIM4_GenerateEvent:
                                    269 ;	lib/src/stm8s_tim4.c: 263: TIM4->EGR = (uint8_t)(TIM4_EventSource);
      0084A7 C7 53 45         [ 1]  270 	ld	0x5345, a
      ...
      0084AA 81               [ 4]  272 	ret
                                    ...
                                    276 ;	-----------------------------------------
      0084AB                        277 _TIM4_SetCounter:
                                    278 ;	lib/src/stm8s_tim4.c: 275: TIM4->CNTR = (uint8_t)(Counter);
      0084AB C7 53 46         [ 1]  279 	ld	0x5346, a
      ...
      0084AE 81               [ 4]  281 	ret
                                    ...
                                    285 ;	-----------------------------------------
      0084AF                        286 _TIM4_SetAutoreload:
                                    287 ;	lib/src/stm8s_tim4.c: 287: TIM4->ARR = (uint8_t)(Autoreload);
      0084AF C7 53 48         [ 1]  288 	ld	0x5348, a
      ...
      0084B2 81               [ 4]  290 	ret
                                    ...
                                    294 ;	-----------------------------------------
      0084B3                        295 _TIM4_GetCounter:
                                    296 ;	lib/src/stm8s_tim4.c: 298: return (uint8_t)(TIM4->CNTR);
      0084B3 C6 53 46         [ 1]  297 	ld	a, 0x5346
      ...
      0084BA 81               [ 4]  308 	ret
                                    ...
                                    312 ;	-----------------------------------------
      0084BB                        313 _TIM4_GetFlagStatus:
      0084BB 97               [ 1]  314 	ld	xl, a
                                    315 ;	lib/src/stm8s_tim4.c: 326: if ((TIM4->SR1 & (uint8_t)TIM4_FLAG)  != 0)
      0084BC C6 53 44         [ 1]  316 	ld	a, 0x5344
      0084BF 89               [ 2]  317 	pushw	x
      0084C0 14 02            [ 1]  318 	and	a, (2, sp)
      0084C2 85               [ 2]  319 	popw	x
      0084C3 4D               [ 1]  320 	tnz	a
      0084C4 27 03            [ 1]  321 	jreq	00102$
                                    322 ;	lib/src/stm8s_tim4.c: 328: bitstatus = SET;
      0084C6 A6 01            [ 1]  323 	ld	a, #0x01
      0084C8 81               [ 4]  324 	ret
      0084C9                        325 00102$:
                                    326 ;	lib/src/stm8s_tim4.c: 332: bitstatus = RESET;
      0084C9 4F               [ 1]  327 	clr	a
      ...
      0084CA 81               [ 4]  330 	ret
                                    ...
                                    334 ;	-----------------------------------------
      0084CB                        335 _TIM4_ClearFlag:
                                    336 ;	lib/src/stm8s_tim4.c: 350: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      0084CB 43               [ 1]  337 	cpl	a
      0084CC C7 53 44         [ 1]  338 	ld	0x5344, a
      ...
      0084CF 81               [ 4]  340 	ret
                                    ...
                                    344 ;	-----------------------------------------
      0084D0                        345 _TIM4_GetITStatus:
      0084D0 52 02            [ 2]  346 	sub	sp, #2
      0084D2 97               [ 1]  347 	ld	xl, a
                                    348 ;	lib/src/stm8s_tim4.c: 369: itstatus = (uint8_t)(TIM4->SR1 & (uint8_t)TIM4_IT);
      0084D3 C6 53 44         [ 1]  349 	ld	a, 0x5344
      0084D6 41               [ 1]  350 	exg	a, xl
      0084D7 6B 01            [ 1]  351 	ld	(0x01, sp), a
      0084D9 41               [ 1]  352 	exg	a, xl
      0084DA 14 01            [ 1]  353 	and	a, (0x01, sp)
      0084DC 6B 02            [ 1]  354 	ld	(0x02, sp), a
                                    355 ;	lib/src/stm8s_tim4.c: 371: itenable = (uint8_t)(TIM4->IER & (uint8_t)TIM4_IT);
      0084DE C6 53 43         [ 1]  356 	ld	a, 0x5343
      0084E1 14 01            [ 1]  357 	and	a, (0x01, sp)
                                    358 ;	lib/src/stm8s_tim4.c: 373: if ((itstatus != (uint8_t)RESET ) && (itenable != (uint8_t)RESET ))
      0084E3 0D 02            [ 1]  359 	tnz	(0x02, sp)
      0084E5 27 06            [ 1]  360 	jreq	00102$
      0084E7 4D               [ 1]  361 	tnz	a
      0084E8 27 03            [ 1]  362 	jreq	00102$
                                    363 ;	lib/src/stm8s_tim4.c: 375: bitstatus = (ITStatus)SET;
      0084EA A6 01            [ 1]  364 	ld	a, #0x01
                                    365 ;	lib/src/stm8s_tim4.c: 379: bitstatus = (ITStatus)RESET;
      0084EC 21                     366 	.byte 0x21
      0084ED                        367 00102$:
      0084ED 4F               [ 1]  368 	clr	a
      0084EE                        369 00103$:
                                    370 ;	lib/src/stm8s_tim4.c: 381: return ((ITStatus)bitstatus);
                                    371 ;	lib/src/stm8s_tim4.c: 382: }
      0084EE 5B 02            [ 2]  372 	addw	sp, #2
      0084F0 81               [ 4]  373 	ret
                                    374 ;	lib/src/stm8s_tim4.c: 391: void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
                                    375 ;	-----------------------------------------
                                    376 ;	 function TIM4_ClearITPendingBit
                                    377 ;	-----------------------------------------
      0084F1                        378 _TIM4_ClearITPendingBit:
                                    379 ;	lib/src/stm8s_tim4.c: 397: TIM4->SR1 = (uint8_t)(~TIM4_IT);
      0084F1 43               [ 1]  380 	cpl	a
      0084F2 C7 53 44         [ 1]  381 	ld	0x5344, a
