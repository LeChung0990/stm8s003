...
;	main.c: 8: GPIO_DeInit(GPIOB); 	/*CLEAR REGISTER GPIO OR RESET VALUE*/
	ldw	x, #0x5005
	call	_GPIO_DeInit
;	main.c: 9: GPIO_Init(GPIOA, GPIO_PIN_3, GPIO_MODE_OUT_OD_LOW_SLOW);
	push	#0x80
	ld	a, #0x08
	ldw	x, #0x5000
	call	_GPIO_Init
...
;	main.c: 13: while(1) {
00102$:
;	main.c: 14: delay_ms(400);
	ldw	x, #0x0190
	call	_delay_ms
;	main.c: 15: GPIO_WriteReverse(GPIOA, GPIO_PIN_3);	/*Nhap nhay LED tai chan PA3*/
	ld	a, #0x08
	ldw	x, #0x5000
