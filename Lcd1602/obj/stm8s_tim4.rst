      ...
      00813F 81               [ 4]   84 	ret
                                     ...
                                     88 ;	-----------------------------------------
      008140                         89 _TIM4_TimeBaseInit:
                                     90 ;	lib/src/stm8s_tim4.c: 70: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      008140 C7 53 47         [ 1]   91 	ld	0x5347, a
                                     92 ;	lib/src/stm8s_tim4.c: 72: TIM4->ARR = (uint8_t)(TIM4_Period);
      008143 AE 53 48         [ 2]   93 	ldw	x, #0x5348
      008146 7B 03            [ 1]   94 	ld	a, (0x03, sp)
      008148 F7               [ 1]   95 	ld	(x), a
                                     96 ;	lib/src/stm8s_tim4.c: 73: }
      008149 85               [ 2]   97 	popw	x
      00814A 84               [ 1]   98 	pop	a
      00814B FC               [ 2]   99 	jp	(x)
                                    100 ;	lib/src/stm8s_tim4.c: 81: void TIM4_Cmd(FunctionalState NewState)
                                    101 ;	-----------------------------------------
                                    102 ;	 function TIM4_Cmd
                                    103 ;	-----------------------------------------
      00814C                        104 _TIM4_Cmd:
      00814C 88               [ 1]  105 	push	a
      00814D 6B 01            [ 1]  106 	ld	(0x01, sp), a
                                    107 ;	lib/src/stm8s_tim4.c: 89: TIM4->CR1 |= TIM4_CR1_CEN;
      00814F C6 53 40         [ 1]  108 	ld	a, 0x5340
                                    109 ;	lib/src/stm8s_tim4.c: 87: if (NewState != DISABLE)
      008152 0D 01            [ 1]  110 	tnz	(0x01, sp)
      008154 27 07            [ 1]  111 	jreq	00102$
                                    112 ;	lib/src/stm8s_tim4.c: 89: TIM4->CR1 |= TIM4_CR1_CEN;
      008156 AA 01            [ 1]  113 	or	a, #0x01
      008158 C7 53 40         [ 1]  114 	ld	0x5340, a
      00815B 20 05            [ 2]  115 	jra	00104$
      00815D                        116 00102$:
                                    117 ;	lib/src/stm8s_tim4.c: 93: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_CEN);
      00815D A4 FE            [ 1]  118 	and	a, #0xfe
      00815F C7 53 40         [ 1]  119 	ld	0x5340, a
      008162                        120 00104$:
                                    121 ;	lib/src/stm8s_tim4.c: 95: }
      008162 84               [ 1]  122 	pop	a
      008163 81               [ 4]  123 	ret
                                    ...
                                    127 ;	-----------------------------------------
      008164                        128 _TIM4_ITConfig:
      008164 88               [ 1]  129 	push	a
      008165 97               [ 1]  130 	ld	xl, a
                                    131 ;	lib/src/stm8s_tim4.c: 116: TIM4->IER |= (uint8_t)TIM4_IT;
      008166 C6 53 43         [ 1]  132 	ld	a, 0x5343
      008169 6B 01            [ 1]  133 	ld	(0x01, sp), a
                                    134 ;	lib/src/stm8s_tim4.c: 113: if (NewState != DISABLE)
      00816B 0D 04            [ 1]  135 	tnz	(0x04, sp)
      00816D 27 08            [ 1]  136 	jreq	00102$
                                    137 ;	lib/src/stm8s_tim4.c: 116: TIM4->IER |= (uint8_t)TIM4_IT;
      00816F 9F               [ 1]  138 	ld	a, xl
      008170 1A 01            [ 1]  139 	or	a, (0x01, sp)
      008172 C7 53 43         [ 1]  140 	ld	0x5343, a
      008175 20 07            [ 2]  141 	jra	00104$
      008177                        142 00102$:
                                    143 ;	lib/src/stm8s_tim4.c: 121: TIM4->IER &= (uint8_t)(~TIM4_IT);
      008177 9F               [ 1]  144 	ld	a, xl
      008178 43               [ 1]  145 	cpl	a
      008179 14 01            [ 1]  146 	and	a, (0x01, sp)
      00817B C7 53 43         [ 1]  147 	ld	0x5343, a
      00817E                        148 00104$:
                                    149 ;	lib/src/stm8s_tim4.c: 123: }
      00817E 84               [ 1]  150 	pop	a
      00817F 85               [ 2]  151 	popw	x
      008180 84               [ 1]  152 	pop	a
      008181 FC               [ 2]  153 	jp	(x)
                                    154 ;	lib/src/stm8s_tim4.c: 131: void TIM4_UpdateDisableConfig(FunctionalState NewState)
                                    155 ;	-----------------------------------------
                                    156 ;	 function TIM4_UpdateDisableConfig
                                    157 ;	-----------------------------------------
      008182                        158 _TIM4_UpdateDisableConfig:
      008182 88               [ 1]  159 	push	a
      008183 6B 01            [ 1]  160 	ld	(0x01, sp), a
                                    161 ;	lib/src/stm8s_tim4.c: 139: TIM4->CR1 |= TIM4_CR1_UDIS;
      008185 C6 53 40         [ 1]  162 	ld	a, 0x5340
                                    163 ;	lib/src/stm8s_tim4.c: 137: if (NewState != DISABLE)
      008188 0D 01            [ 1]  164 	tnz	(0x01, sp)
      00818A 27 07            [ 1]  165 	jreq	00102$
                                    166 ;	lib/src/stm8s_tim4.c: 139: TIM4->CR1 |= TIM4_CR1_UDIS;
      00818C AA 02            [ 1]  167 	or	a, #0x02
      00818E C7 53 40         [ 1]  168 	ld	0x5340, a
      008191 20 05            [ 2]  169 	jra	00104$
      008193                        170 00102$:
                                    171 ;	lib/src/stm8s_tim4.c: 143: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_UDIS);
      008193 A4 FD            [ 1]  172 	and	a, #0xfd
      008195 C7 53 40         [ 1]  173 	ld	0x5340, a
      008198                        174 00104$:
                                    175 ;	lib/src/stm8s_tim4.c: 145: }
      008198 84               [ 1]  176 	pop	a
      008199 81               [ 4]  177 	ret
                                    ...
                                    181 ;	-----------------------------------------
      00819A                        182 _TIM4_UpdateRequestConfig:
      00819A 88               [ 1]  183 	push	a
      00819B 6B 01            [ 1]  184 	ld	(0x01, sp), a
                                    185 ;	lib/src/stm8s_tim4.c: 163: TIM4->CR1 |= TIM4_CR1_URS;
      00819D C6 53 40         [ 1]  186 	ld	a, 0x5340
                                    187 ;	lib/src/stm8s_tim4.c: 161: if (TIM4_UpdateSource != TIM4_UPDATESOURCE_GLOBAL)
      0081A0 0D 01            [ 1]  188 	tnz	(0x01, sp)
      0081A2 27 07            [ 1]  189 	jreq	00102$
                                    190 ;	lib/src/stm8s_tim4.c: 163: TIM4->CR1 |= TIM4_CR1_URS;
      0081A4 AA 04            [ 1]  191 	or	a, #0x04
      0081A6 C7 53 40         [ 1]  192 	ld	0x5340, a
      0081A9 20 05            [ 2]  193 	jra	00104$
      0081AB                        194 00102$:
                                    195 ;	lib/src/stm8s_tim4.c: 167: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_URS);
      0081AB A4 FB            [ 1]  196 	and	a, #0xfb
      0081AD C7 53 40         [ 1]  197 	ld	0x5340, a
      0081B0                        198 00104$:
                                    199 ;	lib/src/stm8s_tim4.c: 169: }
      0081B0 84               [ 1]  200 	pop	a
      0081B1 81               [ 4]  201 	ret
                                    ...
                                    205 ;	-----------------------------------------
      0081B2                        206 _TIM4_SelectOnePulseMode:
      0081B2 88               [ 1]  207 	push	a
      0081B3 6B 01            [ 1]  208 	ld	(0x01, sp), a
                                    209 ;	lib/src/stm8s_tim4.c: 187: TIM4->CR1 |= TIM4_CR1_OPM;
      0081B5 C6 53 40         [ 1]  210 	ld	a, 0x5340
                                    211 ;	lib/src/stm8s_tim4.c: 185: if (TIM4_OPMode != TIM4_OPMODE_REPETITIVE)
      0081B8 0D 01            [ 1]  212 	tnz	(0x01, sp)
      0081BA 27 07            [ 1]  213 	jreq	00102$
                                    214 ;	lib/src/stm8s_tim4.c: 187: TIM4->CR1 |= TIM4_CR1_OPM;
      0081BC AA 08            [ 1]  215 	or	a, #0x08
      0081BE C7 53 40         [ 1]  216 	ld	0x5340, a
      0081C1 20 05            [ 2]  217 	jra	00104$
      0081C3                        218 00102$:
                                    219 ;	lib/src/stm8s_tim4.c: 191: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_OPM);
      0081C3 A4 F7            [ 1]  220 	and	a, #0xf7
      0081C5 C7 53 40         [ 1]  221 	ld	0x5340, a
      0081C8                        222 00104$:
                                    223 ;	lib/src/stm8s_tim4.c: 193: }
      0081C8 84               [ 1]  224 	pop	a
      0081C9 81               [ 4]  225 	ret
                                    ...
                                    229 ;	-----------------------------------------
      0081CA                        230 _TIM4_PrescalerConfig:
                                    231 ;	lib/src/stm8s_tim4.c: 222: TIM4->PSCR = (uint8_t)Prescaler;
      0081CA C7 53 47         [ 1]  232 	ld	0x5347, a
                                    233 ;	lib/src/stm8s_tim4.c: 225: TIM4->EGR = (uint8_t)TIM4_PSCReloadMode;
      0081CD 7B 03            [ 1]  234 	ld	a, (0x03, sp)
      0081CF C7 53 45         [ 1]  235 	ld	0x5345, a
                                    236 ;	lib/src/stm8s_tim4.c: 226: }
      0081D2 85               [ 2]  237 	popw	x
      0081D3 84               [ 1]  238 	pop	a
      0081D4 FC               [ 2]  239 	jp	(x)
                                    240 ;	lib/src/stm8s_tim4.c: 234: void TIM4_ARRPreloadConfig(FunctionalState NewState)
                                    241 ;	-----------------------------------------
                                    242 ;	 function TIM4_ARRPreloadConfig
                                    243 ;	-----------------------------------------
      0081D5                        244 _TIM4_ARRPreloadConfig:
      0081D5 88               [ 1]  245 	push	a
      0081D6 6B 01            [ 1]  246 	ld	(0x01, sp), a
                                    247 ;	lib/src/stm8s_tim4.c: 242: TIM4->CR1 |= TIM4_CR1_ARPE;
      0081D8 C6 53 40         [ 1]  248 	ld	a, 0x5340
                                    249 ;	lib/src/stm8s_tim4.c: 240: if (NewState != DISABLE)
      0081DB 0D 01            [ 1]  250 	tnz	(0x01, sp)
      0081DD 27 07            [ 1]  251 	jreq	00102$
                                    252 ;	lib/src/stm8s_tim4.c: 242: TIM4->CR1 |= TIM4_CR1_ARPE;
      0081DF AA 80            [ 1]  253 	or	a, #0x80
      0081E1 C7 53 40         [ 1]  254 	ld	0x5340, a
      0081E4 20 05            [ 2]  255 	jra	00104$
      0081E6                        256 00102$:
                                    257 ;	lib/src/stm8s_tim4.c: 246: TIM4->CR1 &= (uint8_t)(~TIM4_CR1_ARPE);
      0081E6 A4 7F            [ 1]  258 	and	a, #0x7f
      0081E8 C7 53 40         [ 1]  259 	ld	0x5340, a
      0081EB                        260 00104$:
                                    261 ;	lib/src/stm8s_tim4.c: 248: }
      0081EB 84               [ 1]  262 	pop	a
      0081EC 81               [ 4]  263 	ret
                                    ...
                                    267 ;	-----------------------------------------
      0081ED                        268 _TIM4_GenerateEvent:
                                    269 ;	lib/src/stm8s_tim4.c: 263: TIM4->EGR = (uint8_t)(TIM4_EventSource);
      0081ED C7 53 45         [ 1]  270 	ld	0x5345, a
      ...
      0081F0 81               [ 4]  272 	ret
                                    ...
                                    276 ;	-----------------------------------------
      0081F1                        277 _TIM4_SetCounter:
                                    278 ;	lib/src/stm8s_tim4.c: 275: TIM4->CNTR = (uint8_t)(Counter);
      0081F1 C7 53 46         [ 1]  279 	ld	0x5346, a
      ...
      0081F4 81               [ 4]  281 	ret
                                    ...
                                    285 ;	-----------------------------------------
      0081F5                        286 _TIM4_SetAutoreload:
                                    287 ;	lib/src/stm8s_tim4.c: 287: TIM4->ARR = (uint8_t)(Autoreload);
      0081F5 C7 53 48         [ 1]  288 	ld	0x5348, a
      ...
      0081F8 81               [ 4]  290 	ret
                                    ...
                                    294 ;	-----------------------------------------
      0081F9                        295 _TIM4_GetCounter:
                                    296 ;	lib/src/stm8s_tim4.c: 298: return (uint8_t)(TIM4->CNTR);
      0081F9 C6 53 46         [ 1]  297 	ld	a, 0x5346
      ...
      008200 81               [ 4]  308 	ret
                                    ...
                                    312 ;	-----------------------------------------
      008201                        313 _TIM4_GetFlagStatus:
      008201 97               [ 1]  314 	ld	xl, a
                                    315 ;	lib/src/stm8s_tim4.c: 326: if ((TIM4->SR1 & (uint8_t)TIM4_FLAG)  != 0)
      008202 C6 53 44         [ 1]  316 	ld	a, 0x5344
      008205 89               [ 2]  317 	pushw	x
      008206 14 02            [ 1]  318 	and	a, (2, sp)
      008208 85               [ 2]  319 	popw	x
      008209 4D               [ 1]  320 	tnz	a
      00820A 27 03            [ 1]  321 	jreq	00102$
                                    322 ;	lib/src/stm8s_tim4.c: 328: bitstatus = SET;
      00820C A6 01            [ 1]  323 	ld	a, #0x01
      00820E 81               [ 4]  324 	ret
      00820F                        325 00102$:
                                    326 ;	lib/src/stm8s_tim4.c: 332: bitstatus = RESET;
      00820F 4F               [ 1]  327 	clr	a
      ...
      008210 81               [ 4]  330 	ret
                                    ...
                                    334 ;	-----------------------------------------
      008211                        335 _TIM4_ClearFlag:
                                    336 ;	lib/src/stm8s_tim4.c: 350: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      008211 43               [ 1]  337 	cpl	a
      008212 C7 53 44         [ 1]  338 	ld	0x5344, a
      ...
      008215 81               [ 4]  340 	ret
                                    ...
                                    344 ;	-----------------------------------------
      008216                        345 _TIM4_GetITStatus:
      008216 52 02            [ 2]  346 	sub	sp, #2
      008218 97               [ 1]  347 	ld	xl, a
                                    348 ;	lib/src/stm8s_tim4.c: 369: itstatus = (uint8_t)(TIM4->SR1 & (uint8_t)TIM4_IT);
      008219 C6 53 44         [ 1]  349 	ld	a, 0x5344
      00821C 41               [ 1]  350 	exg	a, xl
      00821D 6B 01            [ 1]  351 	ld	(0x01, sp), a
      00821F 41               [ 1]  352 	exg	a, xl
      008220 14 01            [ 1]  353 	and	a, (0x01, sp)
      008222 6B 02            [ 1]  354 	ld	(0x02, sp), a
                                    355 ;	lib/src/stm8s_tim4.c: 371: itenable = (uint8_t)(TIM4->IER & (uint8_t)TIM4_IT);
      008224 C6 53 43         [ 1]  356 	ld	a, 0x5343
      008227 14 01            [ 1]  357 	and	a, (0x01, sp)
                                    358 ;	lib/src/stm8s_tim4.c: 373: if ((itstatus != (uint8_t)RESET ) && (itenable != (uint8_t)RESET ))
      008229 0D 02            [ 1]  359 	tnz	(0x02, sp)
      00822B 27 06            [ 1]  360 	jreq	00102$
      00822D 4D               [ 1]  361 	tnz	a
      00822E 27 03            [ 1]  362 	jreq	00102$
                                    363 ;	lib/src/stm8s_tim4.c: 375: bitstatus = (ITStatus)SET;
      008230 A6 01            [ 1]  364 	ld	a, #0x01
                                    365 ;	lib/src/stm8s_tim4.c: 379: bitstatus = (ITStatus)RESET;
      008232 21                     366 	.byte 0x21
      008233                        367 00102$:
      008233 4F               [ 1]  368 	clr	a
      008234                        369 00103$:
                                    370 ;	lib/src/stm8s_tim4.c: 381: return ((ITStatus)bitstatus);
                                    371 ;	lib/src/stm8s_tim4.c: 382: }
      008234 5B 02            [ 2]  372 	addw	sp, #2
      008236 81               [ 4]  373 	ret
                                    374 ;	lib/src/stm8s_tim4.c: 391: void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
                                    375 ;	-----------------------------------------
                                    376 ;	 function TIM4_ClearITPendingBit
                                    377 ;	-----------------------------------------
      008237                        378 _TIM4_ClearITPendingBit:
                                    379 ;	lib/src/stm8s_tim4.c: 397: TIM4->SR1 = (uint8_t)(~TIM4_IT);
      008237 43               [ 1]  380 	cpl	a
      008238 C7 53 44         [ 1]  381 	ld	0x5344, a
