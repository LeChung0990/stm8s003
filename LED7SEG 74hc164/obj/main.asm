...
;	main.c: 8: GPIO_DeInit(GPIOB); 	/*CLEAR REGISTER GPIO OR RESET VALUE*/
	ldw	x, #0x5005
	call	_GPIO_DeInit
;	main.c: 9: GPIO_Init(GPIOB, GPIO_PIN_4, GPIO_MODE_OUT_PP_LOW_FAST);
	push	#0xe0
	ld	a, #0x10
	ldw	x, #0x5005
	call	_GPIO_Init
;	main.c: 10: TIM4_TimeBaseInit(TIM4_PRESCALER_128, 125 - 1);
	push	#0x7c
	ld	a, #0x07
...
;	main.c: 13: while(1) {
00102$:
;	main.c: 14: delay_ms(100);
	ldw	x, #0x0064
	call	_delay_ms
;	main.c: 15: GPIO_WriteReverse(GPIOB, GPIO_PIN_4);	/*Nhap nhay LED tai chan PD3*/
	ld	a, #0x10
	ldw	x, #0x5005
...
;	main.c: 17: }
	ret
;	main.c: 19: void delay_ms(uint16_t u16Delay)
;	-----------------------------------------
;	 function delay_ms
;	-----------------------------------------
_delay_ms:
